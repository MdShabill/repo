...
namespace MyConsoleApp
{
    public class NumericHelper
    {
        ...
        //public static void GetUnmatchedElements()
        //{
        //    int[] array1 = { 1, 2, 3 };
        //    int[] array2 = { 4, 5, 6 };
        ...
        //public static void GetMatchedElementsBetweenTwoArrays()
        //{
        //    int[] array1 = { 1, 2, 3 };
        //    int[] array2 = { 4, 3, 2 };
        ...
        //public static void GetMatchedElementsBetweenThreeArrays()
        //{
        ...
        public static void DisplayTextWithTwoSecondGap()
        {
        ...
        public async Task CallApi()
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                {
                    // Output the HTTP status code if the request was not successful
